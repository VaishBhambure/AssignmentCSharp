    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteArtWorks_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtworkGalleries", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtworkGalleries_ArtworkID_GalleryID",
                table: "ArtworkGalleries",
                columns: new[] { "ArtworkID", "GalleryID" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteArtWorks_UserID_ArtworkID",
                table: "FavoriteArtWorks",
