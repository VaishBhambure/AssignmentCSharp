...
namespace ArtExhibition.Application.Service
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<User> userManager, IArtistRepository artistRepository, IConfiguration configuration, IOptionsSnapshot<JwtSettings> jwtSettings, SignInManager<User> signInManager)
        {
